...
- GitHub Actions tự động chạy test trên PHP 8.2 mỗi khi push hoặc tạo pull request.
...
Seeder tạo sẵn ba tài khoản với mật khẩu chung `password`:

| Vai trò | Email | Mật khẩu |
|---|---|---|
| Admin | `admin@bluewave.test` | `password` |
| Quản lý | `manager@bluewave.test` | `password` |
| Khách hàng | `customer@bluewave.test` | `password` |

Coupon demo: `WELCOME10`.

Các tài khoản và mật khẩu trên chỉ dùng cho môi trường local/demo, không sử dụng trong production.
